...
namespace HRTraining.TestModeling
{
    public class TestModels
    {
        public Workout CanCorrectlyModel_Run_30MinuteHillWorkout()
        {
        ...
        public Workout CanCorrectlyModel_Run_30MinuteLadderWorkout()
        {
            ...
            return ladderWorkout;
        }

        public Workout CanCorrectlyModel_Run_30MinuteRunAndStrengthComboWorkout()
        {
        ...
        public Workout CanCorrectlyModel_Run_30MinuteSprintIntervalWorkout()
        {
        ...
        public Workout CanCorrectlyModel_Run_BeginnerEasyRun()
        {
        ...
        public Workout CanCorrectlyModel_Run_AdvancedEasyRun()
        {
            var easyRun = new Workout()
            {
                ID = Guid.NewGuid(),
        ...
        public Workout CanCorrectlyModel_Run_TempoRun_Beginner()
        {
        ...
        public Workout CanCorrectlyModel_Run_Fartlek()
        {
        ...
        public Workout CanCorrectlyModel_AerobicWorkout_30MinuteIndoorCardio()
        {
            var fartlekWorkout = new Workout()
            {
                ID = Guid.NewGuid(),
        ...
        public Workout CanCorrectlyModel_Elliptical_WorkoutRoutine()
        {
            ...
            return ellipticalWorkout;
        }

        public Workout CanCorrectlyModel_Elliptical_BuildAndBurn()
        {
            var ellipticalWorkout = new Workout()
            {
                ID = Guid.NewGuid(),
        ...
        public Workout CanCorrectlyModel_Run_CustomWorkout()
        {
            ...
            return customRunWorkout;
        }

        public Workout CanCorrectlyModel_Workout_CustomWorkout()
        {
